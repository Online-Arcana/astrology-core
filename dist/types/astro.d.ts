...
export type NodeId = "north_node_true" | "south_node_true" | "north_node_mean" | "south_node_mean";
export type AngleId = "ascendant" | "descendant" | "midheaven" | "imum_coeli" | "vertex" | "antivertex" | "east_point";
...
export type AspectKind = "conjunction" | "opposition" | "trine" | "square" | "sextile" | "quincunx" | "semisextile" | "semisquare" | "sesquiquadrate" | "quintile" | "biquintile";
...
export type PatternKind = "stellium" | "t_square" | "grand_trine" | "grand_cross" | "yod" | "kite" | "mystic_rectangle" | "grand_sextile" | "thor_hammer";
...
export type LunarPhaseName = "new" | "crescent" | "first_quarter" | "gibbous" | "full" | "disseminating" | "last_quarter" | "balsamic";
...
export type TropicalCalculation = ZodiacCalculation & {
    zodiac: "tropical";
    ayanamsha: null;
};
export type SiderealCalculation = ZodiacCalculation & {
    zodiac: "sidereal";
    ayanamsha: Ayanamsha;
};
export type CompatibilityDomain = "overall" | "romantic" | "sexual" | "emotional" | "communication" | "intellectual" | "friendship" | "business" | "domestic" | "long_term" | "conflict_resolution" | "spiritual";
