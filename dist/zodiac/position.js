...
export const normaliseDegrees = (degrees) => {
...
export const signPosition = (longitudeDegrees) => {
    ...
    return {
        ...
        minute: finalMinute,
        second,
        decan: (Math.floor(Math.min(degreeWithinSign, 29.999999999) / 10) + 1),
        degreeWithinSign,
    };
};
export const siderealPosition = (tropicalLongitude, ayanamshaDegrees) => signPosition(tropicalLongitude - ayanamshaDegrees);
