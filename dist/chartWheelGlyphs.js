...
const applyNodeGlyph = (pointId, glyph, wheel) => {
    ...
    if (fallback !== null)
        fallback.textContent = glyph.fallback;
    const image = point.querySelector("image.wheel-glyph-image");
    if (image === null)
        return;
