export const dignityProfile = "traditional_dignity/1.0.0";
export const boundsProfile = "egyptian_bounds/1.0.0";
export const facesProfile = "chaldean_faces/1.0.0";
export const triplicityProfile = "dorothean_triplicity/1.0.0";
...
export const triplicityRules = {
    fire: { day: "sun", night: "jupiter", participating: "saturn" },
    earth: { day: "venus", night: "moon", participating: "mars" },
    air: { day: "saturn", night: "mercury", participating: "jupiter" },
    water: { day: "venus", night: "mars", participating: "moon" },
};
export const exaltationRulers = {
    aries: "sun",
    taurus: "moon",
    cancer: "jupiter",
    virgo: "mercury",
